...
The current version is **v0.5.1**, following v0.5.0 of 2026-09-16. Source builds
...
Commit and push the reviewed project changes, then tag that commit (`v0.5.1` for
