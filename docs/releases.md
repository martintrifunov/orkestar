...
The current version is **v0.3.0**, following v0.2.0 of 2026-09-06. Source builds
...
Commit and push the reviewed project changes, then tag that commit (`v0.3.0` for
