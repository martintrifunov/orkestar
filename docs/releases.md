...
The current version is **v0.5.0**, following v0.4.2 of 2026-09-07. Source builds
...
Commit and push the reviewed project changes, then tag that commit (`v0.5.0` for
