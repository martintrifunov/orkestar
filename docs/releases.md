...
The current version is **v0.4.2**, following v0.4.1 of 2026-09-06. Source builds
...
Commit and push the reviewed project changes, then tag that commit (`v0.4.2` for
